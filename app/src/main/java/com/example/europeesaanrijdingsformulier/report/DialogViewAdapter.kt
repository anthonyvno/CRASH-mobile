...
class DialogViewAdapter ( private val parentActivity: ReportStartAFragment,
private val vehicles: List<Vehicle>): RecyclerView.Adapter<DialogViewAdapter.ViewHolder>() {
    ...
    init {
        onClickListener = View.OnClickListener { v ->
            ...
            parentActivity.startNewFragmentForA(pos)
